...
def evaluate(args, model=None, data_loader=None):
    ...
    pesq, stoi = distrib.average([m/total_cnt for m in metrics], total_cnt)  #is it correct? or should be distrib.average(metrics, total_cnt)
...
def get_pesq(ref_sig, out_sig, sr):
    ...
    for i in range(len(ref_sig)):
        ...
        #print("Reference signal length:", len(ref_sig[i]))
        #print("Output signal length:", len(out_sig[i]))
